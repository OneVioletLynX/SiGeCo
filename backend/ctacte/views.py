...
#     def get(self, request):
#         # base queryset
#         qs = PagoDetalle.objects.all().order_by('pk')  # usar pk en lugar de id_detalle

#         # si recibís filtros por query params, mapearlos a campos reales
#         id_detalle = request.GET.get('id_detalle')
#         if id_detalle:
#             qs = qs.filter(pk=id_detalle)
...
#         ser = PagoDetalleSerializer(qs, many=True)
#         return Response(ser.data)
